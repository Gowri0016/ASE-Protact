...
export default function Contact() {
  ...
  return (
    <>
      <Helmet>
        <title>Contact ASE Protact | Fire Safety Experts in Tiruppur</title>
        <meta name="description" content="Contact ASE Protact for fire safety solutions, product inquiries, and expert support in Tiruppur. Get in touch for a safer tomorrow." />
        <link rel="canonical" href="https://aseprotact.com/contact" />
        {/* Open Graph */}
        <meta property="og:title" content="Contact ASE Protact | Fire Safety Experts in Tiruppur" />
        <meta property="og:description" content="Contact ASE Protact for fire safety solutions, product inquiries, and expert support in Tiruppur. Get in touch for a safer tomorrow." />
        <meta property="og:url" content="https://aseprotact.com/contact" />
        <meta property="og:image" content="https://aseprotact.com/assets/og-image.jpg" />
        {/* Twitter Card */}
        <meta name="twitter:title" content="Contact ASE Protact | Fire Safety Experts in Tiruppur" />
        <meta name="twitter:description" content="Contact ASE Protact for fire safety solutions, product inquiries, and expert support in Tiruppur. Get in touch for a safer tomorrow." />
