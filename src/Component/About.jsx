...
export default function About() {
  ...
  return (
    <>
      <Helmet>
        <title>About ASE Protact - Leading Fire Safety Solutions in Tiruppur</title>
        <meta name="description" content="Learn about ASE Protact, Tiruppur's trusted provider of fire safety equipment and solutions. Discover our mission, values, and leadership." />
        <link rel="canonical" href="https://aseprotact.com/about" />
        {/* Open Graph */}
        <meta property="og:title" content="About ASE Protact - Leading Fire Safety Solutions in Tiruppur" />
        <meta property="og:description" content="Learn about ASE Protact, Tiruppur's trusted provider of fire safety equipment and solutions. Discover our mission, values, and leadership." />
        <meta property="og:url" content="https://aseprotact.com/about" />
        <meta property="og:image" content="https://aseprotact.com/assets/og-image.jpg" />
        {/* Twitter Card */}
        <meta name="twitter:title" content="About ASE Protact - Leading Fire Safety Solutions in Tiruppur" />
        <meta name="twitter:description" content="Learn about ASE Protact, Tiruppur's trusted provider of fire safety equipment and solutions. Discover our mission, values, and leadership." />
