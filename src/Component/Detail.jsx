...
const bannerSlides = [
  {
    ...
    alt: 'Emergency Lighting System - ASE Protact fire safety Tiruppur'
  },
  {
    img: Hydrant,
  ...
  },
  {
    ...
    alt: 'Fireproof Storage Solutions - fire-resistant vaults Tiruppur'
  },
  {
    img: Huper,
    ...
    alt: 'Integrated Building Safety Systems - fire and security integration Tiruppur'
  }
];
...
export default function Detail() {
  ...
  return (
    <>
      <Helmet>
        <title>Product & System Details | ASE Protact Tiruppur</title>
        <meta name="description" content="Discover detailed information about ASE Protact's fire safety products, emergency systems, and advanced protection solutions in Tiruppur." />
        <link rel="canonical" href="https://aseprotact.com/detail" />
        {/* Open Graph */}
        <meta property="og:title" content="Product & System Details | ASE Protact Tiruppur" />
        <meta property="og:description" content="Discover detailed information about ASE Protact's fire safety products, emergency systems, and advanced protection solutions in Tiruppur." />
        <meta property="og:url" content="https://aseprotact.com/detail" />
        <meta property="og:image" content="https://aseprotact.com/assets/og-image.jpg" />
        {/* Twitter Card */}
        <meta name="twitter:title" content="Product & System Details | ASE Protact Tiruppur" />
        <meta name="twitter:description" content="Discover detailed information about ASE Protact's fire safety products, emergency systems, and advanced protection solutions in Tiruppur." />
        <meta name="twitter:image" content="https://aseprotact.com/assets/twitter-image.jpg" />
      </Helmet>
